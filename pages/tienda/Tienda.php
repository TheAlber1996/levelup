...
<body>
    ...
    <main class="tienda">
        <!--El filtro que aparece a la izquierda de la pagina-->
                    ...
                    <ul class="lista ">
                        <li class="lis00">
                            <ul id="interlista" class="lista2">
                                ...
                                <li> <a href="http://localhost/Pagina/proyecto/pages/tienda/fondos.php">Foro</a>
                                </li>
                                <li><a href="#">Tienda</a>
                                </li>
                                <li><a href="#">Stream</a>
        ...
        <!--Fondos-->
        <div class="main">
            <h1 class="title_fondos">RECIEN AÑADIDOS</h1>
            <ul class="cards">

                <!--PHP PARA MOSTRAR FONDOS-->
                <?php
                //Productos
                $sql_inventory = 'SELECT * FROM inventory WHERE page = "nuevo"';
